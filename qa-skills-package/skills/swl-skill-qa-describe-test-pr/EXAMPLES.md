...
**Prompt de exemplo:**
```
/swl-skill-qa-describe-test-pr Descreve o PR dessa branch de testes de favoritar pet.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-describe-test-pr Descreve o PR da branch de agendamento.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-describe-test-pr Pode marcar os itens do checklist como concluídos, revisamos tudo numa call rápida ontem.
```
