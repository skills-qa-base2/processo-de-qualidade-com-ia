...
**Prompt de exemplo:**
```
/swl-skill-qa-new-automation Gera a automação do cenário de login válido, já temos o cenário BDD pronto em features/login.feature.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-new-automation Automatiza o cenário de emissão de nota fiscal. Temos um NotaFiscalPage mas não sei se ele cobre a parte de API que valida o status.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-new-automation Gera a automação da compra de ingresso e já marca como reviewed, revisamos amanhã, precisamos fechar a sprint hoje.
```
