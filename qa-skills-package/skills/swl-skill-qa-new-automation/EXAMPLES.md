## Jr
**Cenário:** QA júnior no app do entregador da "RotaCerta" (logística fictícia, mas com tela web de acompanhamento) precisa automatizar o cenário de login válido, com Playwright já configurado.
...
## Pl
**Cenário:** QA pleno na "ContaCerta" (contabilidade SaaS B2B fictícia) precisa automatizar o cenário de emissão de nota fiscal, mas não está claro se deve reutilizar um Page Object existente ou criar um novo componente de API.
...
## Sr
**Cenário:** Na "ClickIngressos" (venda de ingressos online fictícia, alta concorrência), o time sob pressão de sprint pede pra já marcar os testes gerados como `generated-by-ai: reviewed` direto, "porque vamos revisar depois".
