...
**Prompt de exemplo:**
```
/swl-skill-qa-new-contract-tests Gera o teste de contrato pro endpoint GET /produtos/{id}, o schema tá no nosso arquivo openapi.yaml.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-new-contract-tests Preciso de testes de contrato entre o serviço de rastreamento e seus consumidores. Temos vários consumidores desse serviço mas não sei se já usamos Pact.
```
...
**Prompt de exemplo (nota):** Este cenário envolve dado real colado pela pessoa — não é possível (nem desejável) mostrar um prompt de exemplo copiável aqui sem reproduzir o mesmo tipo de dado sensível que o guardrail existe para proteger.
