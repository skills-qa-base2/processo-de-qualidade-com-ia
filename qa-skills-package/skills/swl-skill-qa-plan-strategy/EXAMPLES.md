## Cenário direto — API
**Cenário:** QA júnior recém-chegado na "AgroConecta" (marketplace agro B2B fictício, API + integrações com ERPs de fornecedores) percebe que nunca houve uma estratégia de teste formal documentada.
...
**Cenário:** QA pleno na "EstudaMais" (plataforma de cursos online fictícia, web) responde às perguntas, mas não tem certeza se existe massa de dados própria de teste.
...
**Cenário:** Na "BancoDigitalX" (banco digital fictício, app mobile + API), a diretoria pede uma estratégia de teste pronta pra apresentar amanhã, e o QA sênior, sem tempo de entrevistar o time todo, pede pra skill "preencher com o que é padrão de mercado pra banco digital".
