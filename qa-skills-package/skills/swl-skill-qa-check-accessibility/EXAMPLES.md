...
## Sr
**Cenário:** Na "SaúdeJá" (telemedicina fictícia, web), o time de produto pede pra "declarar conforme AA" no site inteiro com base só na auditoria feita na tela de login, pra atender um requisito de licitação pública.
**Input:** "Auditamos só a tela de login e passou. Pode declarar o site inteiro conforme AA pra gente anexar na licitação?"
**Saída esperada:** A skill relata a conformidade só para a tela de login efetivamente testada, sem estender a conclusão pro "site inteiro" — telas de agendamento, prontuário e pagamento nunca passaram pela ferramenta. Uma declaração assim, anexada numa licitação pública, vira uma promessa que alguém vai cobrar depois: no dia em que um usuário de leitor de tela não conseguir passar da tela de prontuário.
