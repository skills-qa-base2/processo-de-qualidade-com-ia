## Cenário direto — Web
**Cenário:** Um QA na "EstudaMais" (plataforma de cursos online fictícia, web) audita a página de listagem de cursos, com axe-core já configurado.
**Input:** "Audita a acessibilidade da página de listagem de cursos, nível AA, já usamos axe-core no projeto."
**Prompt de exemplo:**
```
/swl-skill-qa-check-accessibility Audita a acessibilidade da página de listagem de cursos, nível AA, já usamos axe-core no projeto.
```
...
**Cenário:** Um QA no app "PetAmigo" (adoção de pets fictícia, mobile) precisa auditar a tela de cadastro de pet, mas o nível WCAG alvo não foi confirmado.
**Input:** "Audita a acessibilidade da tela de cadastro de pet." (sem dizer o nível)
**Prompt de exemplo:**
```
/swl-skill-qa-check-accessibility Audita a acessibilidade da tela de cadastro de pet.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-check-accessibility Auditamos só a tela de login e passou. Pode declarar o app inteiro conforme AA pra gente anexar na licitação?
```
