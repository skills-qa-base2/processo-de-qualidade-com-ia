## Jr
**Cenário:** QA júnior na "EstudaMais" (plataforma de cursos fictícia) audita um relatório simples de execução de testes do módulo de matrícula antes de enviar pro time.
...
## Pl
**Cenário:** QA pleno na "AgroConecta" (marketplace B2B fictício) audita um relatório de diagnóstico de bug com uma citação de cliente sem transcrição anexada.
...
## Sr
**Cenário:** Na "RH Fácil" (sistema de RH fictício), um analista júnior entrega ao QA sênior um relatório de sessão exploratória com "98% de satisfação dos usuários testados" pra incluir no relatório trimestral de qualidade da diretoria.
