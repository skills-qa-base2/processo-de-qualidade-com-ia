...
**Prompt de exemplo:**
```
/swl-skill-qa-check-data-quality Audita esse relatório de testes do módulo de matrícula antes de eu enviar pro time.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-check-data-quality Audita esse relatório de bug antes de eu abrir o chamado.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-check-data-quality Pode revisar esse relatório antes de eu mandar pra diretoria? Tem um número de satisfação ali.
```
