## Cenário direto — Web
**Cenário:** QA júnior na "EstudaMais" (plataforma de cursos fictícia, web) audita um relatório simples de execução de testes do módulo de matrícula antes de enviar pro time.
...
**Cenário:** QA pleno na "AgroConecta" (marketplace B2B fictício, API) audita um relatório de diagnóstico de bug com uma citação de cliente sem transcrição anexada.
...
**Cenário:** Na "RotaCerta" (app do entregador fictício, mobile), um analista júnior entrega ao QA sênior um relatório de sessão exploratória com "98% de satisfação dos entregadores testados" pra incluir no relatório trimestral de qualidade da diretoria.
