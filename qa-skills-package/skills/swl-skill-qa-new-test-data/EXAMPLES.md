...
**Prompt de exemplo:**
```
/swl-skill-qa-new-test-data Preciso de dados de teste para a entidade Cliente do nosso cadastro (nome, e-mail, telefone, CEP).
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-new-test-data Preciso de dados de teste para Transferência (valor, conta origem, conta destino). O critério de aceite não diz qual o valor máximo por transferência.
```
