...
**Prompt de exemplo:**
```
/swl-skill-qa-generate-test-report Gera o relatório de execução a partir desse JSON do Playwright.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-generate-test-report Gera o relatório dessa execução do app. Não tenho o resultado da execução anterior aqui.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-generate-test-report [dois arquivos de execução anexados — segunda e sexta] Consolida os dois: quero que conte como aprovado qualquer teste que passou em pelo menos uma das duas execuções.
```
