## Jr
**Cenário:** QA júnior na "Lojinha Verde" (e-commerce fictício de plantas) gera o relatório de execução da suíte de checkout a partir do JSON real do Playwright.
...
## Pl
**Cenário:** QA pleno na "EstudaMais" (plataforma de cursos fictícia) gera o relatório de uma execução com uma falha, sem execução anterior disponível pra comparar.
**Input:** "Gera o relatório dessa execução." (1 falha em 20 testes) + "não tenho o resultado da execução anterior aqui."
...
## Sr
**Cenário:** Na "StreamPlay" (streaming de vídeo fictício), antes de uma reunião de status, o gerente de projeto pede pra "consolidar" duas execuções diferentes (segunda e sexta) somando os testes que passaram em qualquer uma das duas, "pra mostrar cobertura maior".
