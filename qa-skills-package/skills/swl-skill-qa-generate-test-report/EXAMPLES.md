## Cenário direto — Web
**Cenário:** QA júnior na "Lojinha Verde" (e-commerce fictício de plantas, web) gera o relatório de execução da suíte de checkout a partir do JSON real do Playwright.
...
**Cenário:** QA pleno no app "PetAmigo" (adoção de pets fictícia, mobile) gera o relatório de uma execução com uma falha, sem execução anterior disponível pra comparar.
