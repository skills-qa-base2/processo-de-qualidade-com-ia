## Cenário direto — Web
**Cenário:** QA júnior na "Lojinha Verde" (e-commerce fictício de plantas, web) confirma que o ambiente de staging está pronto antes de rodar a suíte de checkout.
...
**Cenário:** QA pleno na "AgroConecta" (marketplace B2B fictício, API) verifica o ambiente antes da suíte de negociação de preço rodar, mas não há documentação de quais feature flags deveriam estar ativas.
