...
**Prompt de exemplo:**
```
/swl-skill-qa-check-environment Confirma que o staging está pronto antes de eu rodar a suíte de regressão do checkout.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-check-environment Verifica o ambiente de staging antes da suíte de negociação de preço rodar.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-check-environment Pode rodar a suíte já, o ambiente de performance sempre tá ok, não precisa checar.
```
