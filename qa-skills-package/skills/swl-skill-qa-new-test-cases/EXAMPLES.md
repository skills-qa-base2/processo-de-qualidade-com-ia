...
## Sr
**Cenário:** Na "BancoDigitalX" (banco digital fictício, app mobile), a user story de bloqueio de cartão após tentativas de senha erradas chega sem o número oficial de tentativas, e o time de produto, sem tempo, sugere "usar 3, é o mais comum no mercado".
