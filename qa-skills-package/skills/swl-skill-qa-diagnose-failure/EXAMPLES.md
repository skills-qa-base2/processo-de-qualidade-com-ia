## Jr
**Cenário:** QA júnior na "Lojinha Verde" (e-commerce fictício de plantas) vê um teste de checkout falhar no CI com uma mensagem de assert clara.
...
## Sr
**Cenário:** Na "PagaFácil", a equipe de infraestrutura explica que uma falha recorrente no fechamento de fatura em produção é "só instabilidade de rede", pedindo apenas retry no teste pra ele passar.
