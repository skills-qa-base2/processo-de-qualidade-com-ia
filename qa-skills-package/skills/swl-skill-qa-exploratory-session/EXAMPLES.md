...
**Cenário:** Um QA no app "PetAmigo" (adoção de pets fictícia) faz sua primeira sessão exploratória na tela de busca de pets.
**Input:** "Quero fazer uma sessão exploratória na busca de pets, tenho 1 hora."
**Prompt de exemplo:**
```
/swl-skill-qa-exploratory-session Quero fazer uma sessão exploratória na busca de pets, tenho 1 hora.
```
...
**Cenário:** Um QA na "AgroConecta" (marketplace B2B fictício, web) conduz sessão exploratória no checkout, mas é interrompido antes de testar uma parte do fluxo planejado.
...
**Prompt de exemplo:**
```
/swl-skill-qa-exploratory-session Testei boa parte do fluxo de negociação de preço, mas fui interrompido antes de testar o fluxo de aprovação em duas etapas.
```
...
**Cenário:** Na "RH Fácil" (sistema de RH fictício, com integração ao processador de folha de pagamento externo), o QA conduz uma sessão de 45 minutos na tela de folha de pagamento, e o gerente pede pro relatório dizer que "o módulo de folha inteiro foi testado" pra justificar a liberação do release.
**Input:** "Coloca no relatório que testamos o módulo de folha inteiro, deu pra ver bastante coisa nessa sessão."
**Prompt de exemplo:**
```
/swl-skill-qa-exploratory-session Coloca no relatório que testamos o módulo de folha inteiro, deu pra ver bastante coisa nessa sessão.
```
