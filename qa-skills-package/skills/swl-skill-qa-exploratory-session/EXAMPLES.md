...
## Pl
**Cenário:** QA pleno na "AgroConecta" (marketplace B2B fictício) conduz sessão exploratória no checkout, mas é interrompido antes de testar uma parte do fluxo planejado.
...
## Sr
**Cenário:** Na "RH Fácil" (sistema de RH fictício), o QA sênior conduz uma sessão de 45 minutos na tela de folha de pagamento, e o gerente pede pro relatório dizer que "o módulo de folha inteiro foi testado" pra justificar a liberação do release.
**Input:** "Coloca no relatório que testamos o módulo de folha inteiro, deu pra ver bastante coisa nessa sessão."
**Saída esperada:** O relatório lista como "áreas cobertas" exatamente as três telas exercitadas (cálculo de horas extras, desconto de INSS, geração de holerite) — não o módulo inteiro, que também inclui rescisão e 13º salário, nenhum dos dois tocados nesses 45 minutos. Um release liberado com base num relatório que diz "módulo inteiro testado" deixa ninguém sabendo que rescisão ficou sem nenhum teste, até um problema aparecer lá.
