## Jr
**Cenário:** QA júnior na "AgroConecta" (marketplace B2B fictício) verifica a cobertura do módulo de negociação de preço entre comprador e vendedor.
...
## Pl
**Cenário:** QA pleno na "EstudaMais" (plataforma de cursos fictícia) verifica cobertura do módulo de emissão de certificado, com critérios parcialmente documentados.
