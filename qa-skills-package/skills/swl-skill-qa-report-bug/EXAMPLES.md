## Jr
**Cenário:** QA júnior na "Lojinha Verde" (e-commerce fictício de plantas) encontra um bug claro no botão de checkout.
...
## Pl
**Cenário:** QA pleno na "PagaFácil" (fintech de pagamentos fictícia) reporta um bug sem informar o navegador ou dispositivo usado.
...
## Sr
**Cenário:** Na "ClickIngressos" (venda de ingressos fictícia), dias antes de um lançamento, o suporte pede pra abrir um bug urgente de "ingresso duplicado" mandando só um print da tela de confirmação, sem descrever os passos nem confirmar se conseguiu reproduzir de novo.
