...
**Prompt de exemplo:**
```
/swl-skill-qa-report-bug Encontrei um bug: o botão de finalizar compra não faz nada quando clico duas vezes rápido.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-report-bug A tela de extrato trava às vezes.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-report-bug [print anexado] Emergência: cliente com dois ingressos iguais na conta. Prioridade máxima nisso.
```
