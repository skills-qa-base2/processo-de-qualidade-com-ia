## Cenário direto — Web
**Cenário:** QA júnior na "Lojinha Verde" (e-commerce fictício de plantas, web) encontra um bug claro no botão de checkout.
...
**Cenário:** QA pleno na "PagaFácil" (fintech de pagamentos fictícia, API) reporta um bug sem informar o navegador ou dispositivo usado.
