## Jr
**Cenário:** QA júnior na "ClickIngressos" (venda de ingressos online fictícia) quer um smoke test simples do endpoint de listagem de eventos, com k6 já configurado.
...
## Pl
**Cenário:** QA pleno na "StreamPlay" (streaming de vídeo fictício) quer testar a API de início de reprodução, mas só definiu o tipo de teste (load), sem os thresholds.
...
## Sr
**Cenário:** Na "BancoDigitalX" (banco digital fictício), o time de infra pede um teste de stress pro endpoint de autenticação antes de um evento de marketing com pico esperado de acessos, mas ninguém do time de negócio respondeu quais números de SLA valem, e o prazo é hoje.
