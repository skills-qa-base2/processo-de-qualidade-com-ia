...
Esclareça com o usuário qual tipo de teste é necessário — nunca assuma "load" por padrão sem essa definição:
...
Pergunte e registre os limites aceitáveis: latência p95/p99, taxa de erro máxima, RPS mínimo esperado. Nunca invente um SLA/threshold não informado — marque como "a confirmar com o responsável pelo SLA" se não fornecido.
