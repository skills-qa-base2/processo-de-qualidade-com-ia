...
**Prompt de exemplo:**
```
/swl-skill-qa-check-security Verifica a segurança do endpoint de login em https://tarefacerta-staging.exemplo.com/login.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-check-security Verifica a segurança do endpoint GET /api/relatorios/exportar. Não sei se já temos ferramenta de segurança configurada no projeto.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-check-security Preciso que confirme que o app está aprovado em segurança pra lançarmos amanhã. Testamos login com token inválido, o resto não deu tempo.
```
