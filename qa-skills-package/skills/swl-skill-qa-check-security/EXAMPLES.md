## Jr
**Cenário:** QA júnior no "TarefaCerta" (app web fictício de gestão de tarefas, stack Node/Express) precisa checar a segurança básica da tela de login.
...
## Pl
**Cenário:** QA pleno no "TarefaCerta" quer verificar o endpoint de exportação de relatórios, mas não sabe se o time já tem alguma ferramenta de segurança configurada.
