...
## Pl
**Cenário:** QA pleno na "AgroConecta" (marketplace B2B fictício) revisa um teste de listagem de fornecedores com nome genérico.
...
## Sr
**Cenário:** Na "PagaFácil" (fintech de pagamentos fictícia), o QA sênior recebe 8 testes gerados por IA pro fluxo de estorno, já marcados como `generated-by-ai: reviewed`, com o tech lead pedindo "só confirma que tá tudo certo, é rotina".
