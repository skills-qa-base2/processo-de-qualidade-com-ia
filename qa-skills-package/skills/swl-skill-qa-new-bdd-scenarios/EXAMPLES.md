...
**Prompt de exemplo:**
```
/swl-skill-qa-new-bdd-scenarios Critério: usuário busca por nome de produto e vê os resultados correspondentes.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-new-bdd-scenarios Critério: usuário assina o plano premium e, se for a segunda assinatura do mesmo usuário, recebe desconto.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-new-bdd-scenarios Critério: se o cliente pedir estorno dentro do prazo, o sistema calcula a taxa de reversão aplicável e notifica o usuário do resultado. Quero só um cenário pra isso, não precisa separar em vários.
```
