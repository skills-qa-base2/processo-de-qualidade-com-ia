## Cenário direto — Web
**Cenário:** QA júnior na "Lojinha Verde" (e-commerce de plantas, web) recebe um critério de aceite simples de busca de produto.
...
**Cenário:** QA pleno no app mobile da "TarefaCerta" (gestão de tarefas fictícia) recebe um critério de assinatura de plano com regra de desconto pouco clara.
