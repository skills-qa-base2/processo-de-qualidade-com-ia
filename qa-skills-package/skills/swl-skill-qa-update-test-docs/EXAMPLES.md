...
**Prompt de exemplo:**
```
/swl-skill-qa-update-test-docs Atualiza a documentação de testes com base nessa branch que adicionou o cenário de cupom.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-update-test-docs Atualiza a documentação, removemos um cenário de frete que não existe mais.
```
...
**Prompt de exemplo:**
```
/swl-skill-qa-update-test-docs Pode limpar toda a documentação de testes antiga e escrever do zero, ninguém usa mais aquilo.
```
