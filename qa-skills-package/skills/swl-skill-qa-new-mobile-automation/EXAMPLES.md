## Jr
**Cenário:** QA júnior no app "PetAmigo" (adoção de pets fictícia) precisa automatizar a tela de favoritar um pet, com Detox já configurado.
...
## Pl
**Cenário:** QA pleno na "BancoDigitalX" (banco digital fictício) precisa automatizar a aprovação de transferência via biometria, mas não está claro se o projeto já trata o diálogo nativo de biometria em algum outro teste.
...
## Sr
**Cenário:** Na "RotaCerta" (app do entregador fictício), o QA sênior testou só no emulador Android mais recente, mas o gerente de operações pede pra "confirmar que funciona em todos os celulares dos entregadores" pra aprovar o rollout geral.
